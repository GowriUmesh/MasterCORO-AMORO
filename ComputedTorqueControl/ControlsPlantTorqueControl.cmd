...
!
data_element create plant input  &
   plant_input_name = .Biglide.PINPUT_2  &
   adams_id = 2  &
   variable_name =  &
      .Biglide.f1,  &
      .Biglide.f2
...
!
data_element create plant output  &
   plant_output_name = .Biglide.POUTPUT_2  &
   adams_id = 2  &
   variable_name =  &
      .Biglide.q1,  &
      .Biglide.q2
...
!
marker create  &
   marker_name = .Biglide.ground.MARKER_35  &
   adams_id = 35  &
   location = 0.2, 0.0, 0.0  &
   orientation = 180.0d, 90.0d, 180.0d
!
marker create  &
   marker_name = .Biglide.ground.MARKER_37  &
   adams_id = 37  &
   location = -0.2, 0.0, 0.0  &
   orientation = 180.0d, 90.0d, 180.0d
!
...
!
marker create  &
   marker_name = .Biglide.Foot1.MARKER_30  &
   adams_id = 30  &
   location = -0.45, -0.5, 0.0  &
   orientation = 0.0d, 0.0d, 0.0d
!
marker create  &
   marker_name = .Biglide.Foot1.MARKER_31  &
   adams_id = 31  &
   location = -0.45, -0.5, 0.0  &
   orientation = 0.0d, 0.0d, 0.0d
!
marker create  &
   marker_name = .Biglide.Foot1.MARKER_36  &
   adams_id = 36  &
   location = -0.2, 0.0, 0.0  &
   orientation = 180.0d, 90.0d, 180.0d
!
...
!
marker create  &
   marker_name = .Biglide.Foot2.MARKER_34  &
   adams_id = 34  &
   location = 0.2, 0.0, 0.0  &
   orientation = 180.0d, 90.0d, 180.0d
!
...
force create direct single_component_force  &
   single_component_force_name = .Biglide.SFORCE_2  &
   adams_id = 2  &
   type_of_freedom = translational  &
   i_marker_name = .Biglide.Foot2.MARKER_34  &
   j_marker_name = .Biglide.ground.MARKER_35  &
   action_only = on  &
   function = ""
!
force create direct single_component_force  &
   single_component_force_name = .Biglide.SFORCE_3  &
   adams_id = 3  &
   type_of_freedom = translational  &
   i_marker_name = .Biglide.Foot1.MARKER_36  &
   j_marker_name = .Biglide.ground.MARKER_37  &
   action_only = on  &
   function = ""
!
!----------------------------- Simulation Scripts -----------------------------!
...
!
ude create instance  &
   instance_name = .Biglide.Controls_Plant_CTC  &
   definition_name = .controls.controls_plant  &
   location = 0.0, 0.0, 0.0  &
   orientation = 0.0, 0.0, 0.0
!
ude create instance  &
   instance_name = .Biglide.general_motion_1  &
...
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.input_channels  &
   object_value =   &
      .Biglide.f1,  &
      .Biglide.f2
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.output_channels  &
   object_value =   &
      .Biglide.q1,  &
      .Biglide.q2
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.file_name  &
   string_value = "ControlsPlantTorqueControl"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.event_name  &
   string_value = ""
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.FMI_Master  &
   string_value = "none"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.host  &
   string_value = "DESKTOP-1FI5JCT"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.output_rate  &
   integer_value = 1
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.realtime  &
   string_value = "off"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.include_mnf  &
   string_value = "no"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.hp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.pv_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.gp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.pf_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_CTC.ude_group  &
   object_value = (NONE)
!
ude modify instance  &
   instance_name = .Biglide.Controls_Plant_CTC
...
!
variable modify  &
   variable_name = .Biglide.general_motion_1.i_marker  &
   object_value = (.Biglide.Foot1.MARKER_9)
!
variable modify  &
   variable_name = .Biglide.general_motion_1.j_marker  &
   object_value = (.Biglide.ground.MARKER_10)
!
variable modify  &
   variable_name = .Biglide.general_motion_1.constraint  &
   object_value = (.Biglide.JOINT_Pa1)
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t1_type  &
   integer_value = 0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t2_type  &
   integer_value = 0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t3_type  &
   integer_value = 0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r1_type  &
   integer_value = 0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r2_type  &
   integer_value = 0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r3_type  &
   integer_value = 0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t1_func  &
   string_value = "0 * time"
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t2_func  &
   string_value = "0 * time"
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t3_func  &
   string_value = "0 * time"
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r1_func  &
   string_value = "0 * time"
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r2_func  &
   string_value = "0 * time"
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r3_func  &
   string_value = "0 * time"
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t1_ic_disp  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t2_ic_disp  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t3_ic_disp  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r1_ic_disp  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r2_ic_disp  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r3_ic_disp  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t1_ic_velo  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t2_ic_velo  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.t3_ic_velo  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r1_ic_velo  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r2_ic_velo  &
   real_value = 0.0
!
variable modify  &
   variable_name = .Biglide.general_motion_1.r3_ic_velo  &
   real_value = 0.0
!
ude modify instance  &
   instance_name = .Biglide.general_motion_1
...
geometry create shape force  &
   force_name = .Biglide.SFORCE_2_force_graphic_1  &
   adams_id = 3  &
   force_element_name = .Biglide.SFORCE_2  &
   applied_at_marker_name = .Biglide.Foot2.MARKER_34
!
geometry create shape force  &
   force_name = .Biglide.SFORCE_3_force_graphic_1  &
   adams_id = 4  &
   force_element_name = .Biglide.SFORCE_3  &
   applied_at_marker_name = .Biglide.Foot1.MARKER_36
!
!----------------------------- Analysis settings ------------------------------!
!
!
...
!
variable create  &
   variable_name = .Biglide.layout_config  &
   integer_value = 1
!
...
data_element modify variable  &
   variable_name = .Biglide.q1  &
   function = "DY(.Biglide.Foot1.MARKER_26, .Biglide.ground.Ground_Ref, .Biglide.ground.Ground_Ref)"
!
data_element modify variable  &
   variable_name = .Biglide.q2  &
   function = "DY(.Biglide.Foot2.MARKER_16, .Biglide.ground.Ground_Ref, .Biglide.ground.Ground_Ref)"
!
force modify direct single_component_force  &
   single_component_force_name = .Biglide.SFORCE_2  &
   function = "VARVAL(.Biglide.f2)"
!
force modify direct single_component_force  &
   single_component_force_name = .Biglide.SFORCE_3  &
   function = "VARVAL(.Biglide.f1)"
!
!-------------------------- Adams View UDE Instance ---------------------------!
!
!
...
geometry modify shape force  &
   force_name = .Biglide.SFORCE_2_force_graphic_1  &
   applied_at_marker_name = (.Biglide.SFORCE_2.i)
!
geometry modify shape force  &
   force_name = .Biglide.SFORCE_3_force_graphic_1  &
   applied_at_marker_name = (.Biglide.SFORCE_3.i)
!
model display  &
   model_name = Biglide
