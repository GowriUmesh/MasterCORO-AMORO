...
!
data_element create variable  &
   variable_name = .Biglide.q1d  &
   adams_id = 17  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .Biglide.q2d  &
   adams_id = 18  &
   initial_condition = 0.0  &
   function = ""
!
...
!
data_element create plant input  &
   plant_input_name = .Biglide.PINPUT_KinematicControl  &
   adams_id = 3  &
   variable_name =  &
      .Biglide.q1d,  &
      .Biglide.q2d
...
!
ude create instance  &
   instance_name = .Biglide.Controls_Plant_1  &
...
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.input_channels  &
   object_value =   &
      .Biglide.q1d,  &
      .Biglide.q2d
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.output_channels  &
   object_value =   &
      .Biglide.q1,  &
      .Biglide.q2
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.file_name  &
   string_value = "ControlsPlantKinematicControl"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.event_name  &
   string_value = ""
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.FMI_Master  &
   string_value = "none"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.host  &
   string_value = "DESKTOP-1FI5JCT"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.output_rate  &
   integer_value = 1
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.realtime  &
   string_value = "off"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.include_mnf  &
   string_value = "no"
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.hp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.pv_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.gp_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.pf_group  &
   object_value = (NONE)
!
variable modify  &
   variable_name = .Biglide.Controls_Plant_1.ude_group  &
   object_value = (NONE)
!
ude modify instance  &
   instance_name = .Biglide.Controls_Plant_1
...
constraint modify motion_generator  &
   motion_name = .Biglide.MOTION_1  &
   function = "VARVAL(.Biglide.q1d)"
!
constraint modify motion_generator  &
   motion_name = .Biglide.MOTION_2  &
   function = "VARVAL(.Biglide.q2d)"
!
